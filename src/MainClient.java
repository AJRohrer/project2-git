...
public class MainClient {
	...
	public static void main(String[] args) {
		...
		Product googles = productManager.addProduct("goggles", "swim goggles", 5, Integer.parseInt(partner1.getId()));
		System.out.println(googles.getDescription() + "were added to the MarketPlace and the DB.");
		
		//*****************ADD Products to PARTNER FUNCTIONALITY*******************************************
		partner1 = partManager.addProductToPartner("candle", "white candle", 2, Integer.parseInt(partner1.getId()));
		...
		ArrayList<Integer> myProductIDs = new ArrayList<>();
		myProductIDs.add(Integer.parseInt(googles.getId()));
		int tempCustomerID = 3;
		...
		int orderID = Integer.parseInt(myGoggleOrder.getId());
		...
		System.out.println("This is your order status: " + orderManager.getOrderStatus(Integer.parseInt(o2.getId())));
